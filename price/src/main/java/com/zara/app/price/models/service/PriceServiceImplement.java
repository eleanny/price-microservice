...
public class PriceServiceImplement implements IPriceService{
	...
	public Price findPriceByDateAndProductIdAndBranId(Date dateApp, Integer productId, Integer brandId) throws SQLException {
		
		return priceDao.findPriceByDateAndProductIdAndBranId(dateApp, productId, brandId);
	}
